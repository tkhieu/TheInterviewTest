...
- **API endpoints** (T1.4, T2.1, T2.2) — Campaign Sequelize model + REST CRUD with the §6 error envelope; scheduling and the async-send transition machine; recipients endpoints
